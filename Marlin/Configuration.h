...
#define STRING_CONFIG_H_AUTHOR "ruevs" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "PAR Anycubic Kossel"
...
#define DELTA
  ...
  #define DELTA_HEIGHT 268.1 // get this value from auto calibrate

  #define DELTA_ENDSTOP_ADJ { 0.0, 0.0, 0.0 } // get these from auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 99.8 //mm  Get this value from auto calibrate
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 80, 91 }  // default steps per unit for Kossel (GT2, 20 tooth)
